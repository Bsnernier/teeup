    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="signupContainer">
        <label className="signupLabel">
          Email
          <input className="signupInput" type="text" value={email} onChange={(e) => setEmail(e.target.value)} required />
        </label>
        <label className="signupLabel">
          Username
        ...
        <div>
          ...
          <button className="signupButton" type="click" onClick={() => (window.location.href = "/login")}>
